    ...
    public partial class Student_Add : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string sql="update Student set Sno='"+textBox1.Text+"' where Sno='" + str[0]+"'";
                    Dao dao=new Dao();
                    dao.Execute(sql);
                    str[0] = textBox1.Text;
                }
                ...
                {
                    string sql = "update Student set Sname='" + textBox2 .Text + "' where Sno='" + str[0] + "'";
                    Dao dao = new Dao();
                    dao.Execute(sql);
                    str[1] = textBox2.Text;
                }
                ...
                {
                    string sql = "update Student set Ssex='" + textBox3.Text + "' where Sno='" + str[0] + "'";
                    Dao dao = new Dao();
                    dao.Execute(sql);
                    str[2] = textBox3.Text;
                }
                ...
                {
                    string sql = "update Student set Sbirth='" + textBox4.Text + "' where Sno='" + str[0] + "'";
                    Dao dao = new Dao();
                    dao.Execute(sql);
                    str[3] = textBox4.Text;
                }
                ...
                {
                    string sql = "update Student set Sclass='" + textBox5.Text + "' where Sno='" + str[0] + "'";
                    Dao dao = new Dao();
                    dao.Execute(sql);
                    str[4] = textBox5.Text;
                }
